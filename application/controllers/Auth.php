...
class Auth extends CI_Controller
{
	...
	public function password_recover()
	{
		...
		$user_id = $this->db->get_where('users', array('email' => $email))->row()->id;

		if(!$user_id)
		{
			$this->session->set_flashdata('errors', 'No email found!!');
		}
		...
		if ($this->form_validation->run() == true) {
			...
			if ($update_password == true) {
                $this->session->set_flashdata('success', 'Password Reset Succesful. Please check your email');
	...
	/**
	 * ------------------ Ion Auth Implementations - Not used in this application. Code preserved for future purpose. -----------------------
	 */
	...
	/**
	 * Forgot password - Ion Auth Implementation
	 */
