...
class Ion_auth_model extends CI_Model
{
	...
	public function get_users_groups($id = FALSE)
	{
		...
		return $this->db->select($this->tables['users_groups'] . '.' . $this->join['groups'] . ' as id, ' . $this->tables['groups'] . '.name, ' . $this->tables['groups'] . '.description, ' . $this->tables['groups'] . '.permission')
	 ...
	 * @author aditya menon
	 */
	public function create_group($permission, $group_name = FALSE, $group_description = '', $additional_data = [])
	{
		...
		$data = ['name' => $group_name, 'description' => $group_description, 'permission' => $permission];
